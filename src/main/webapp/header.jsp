    ...
    <div class="header-top">
        <div class="left-group">
            ...
            <div class="search-box">
                <form id="searchForm" action="<c:url value='/searchResult.jsp'/>" method="get" autocomplete="off">
                    <input type="text" id="searchInput" name="q" placeholder="30만원대로 떠나는 가성비 보라카이!" autocomplete="off">
