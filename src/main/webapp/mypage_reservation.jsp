...
<%
    ...
    try {
        ...
        if (monthParam != null && !monthParam.isEmpty())
            months = Integer.parseInt(monthParam);
    } catch (Exception e) {
        months = 1;
    }
...
<div class="mypage-wrapper in">
    ...
    <aside class="mypage-sidebar">
        <h2><a href="mypage/mypage.jsp">마이페이지</a></h2>
        <ul class="menu">
            <li class="menu-item">
    ...
    <div class="mypage-content">
        ...
        <div class="tab-container">
            <a href="?tab=reservation&months=1"
               class="tab <%= "reservation".equals(activeTab) ? "active" : "" %>">예약내역</a>
        ...
        <table class="reservation-table">
            ...
            <tr>
                <td colspan="7" class="empty">예약하신 내역이 없습니다.</td>
            </tr>
            <% } else {
            ...
            <tr>
                <td colspan="7" class="empty">취소하신 내역이 없습니다.</td>
            </tr>
            <% } else {
