...
public class PackageRepository {
	...
	static {
		...
		packageList.add(
			new Package(7, "싱가포르 야경 여행 5일", "인천", "싱가포르", "싱가포르", 1190000, 5.0, "image/package/singapore.jpg"));
		...
		packageList.add(
			new Package(12, "로스앤젤레스 해변 여행 7일", "김포", "로스앤젤레스", "미국", 2980000, 7.0, "image/package/losangeles.jpg"));
		...
		// 일본 패키지 추가
		packageList.add(
			new Package(16, "오키나와 휴양 여행 4일", "김포", "오키나와", "일본", 1380000, 4.0, "image/package/bangkok.jpg"));
		...
		// 미국 패키지 추가
		packageList.add(
			new Package(19, "샌프란시스코 골든게이트 투어 4일", "인천", "샌프란시스코", "미국", 1420000, 4.0, "image/package/paris.jpg"));
		packageList.add(
			new Package(20, "라스베이거스 카지노 여행 3일", "김포", "라스베이거스", "미국", 1190000, 3.0, "image/package/london.jpg"));
